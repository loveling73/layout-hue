            ...
            <>
                ...
                <Layout style={{ height: '770px' }}>
                    ...
                    <Layout className='flex flex-1'>
                        ...
                        <Header title='Tổng quan' avatar={avatar} />
                       <Row gutter={[16, 16]}>
                            <Col span={6} />
                            <Col span={6} />
                            <Col span={6} />
                            ...
                            {/* <div className='flex items-center'>
                                <div className='bg-white box-border h-20 box1 p-4 border-2 m-5'>
                                    áđâsđá
                                </div>
                                <div className={cx('bg-white box-border box1 p-4 border-2 m-5')}>
                                    ađâsddddáđâsd
                                </div>
                            </div>
